...
class SpeechTranscriptionApp:
    ...
    def add_db_record(self):
        ...
        Status = self.action
        Duration =None
        Selected_Guest_Language_Code=None
        id=None
        Name=None
        ...
        result = poly_db.add_record(self.starttime, Duration, Status,Name,id,CLi,User_language,Selected_Guest_Language_Code,server)
        if result['status'] == True:
